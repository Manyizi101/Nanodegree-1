...
### Scatterplots
Notes: qplot automatically produces scatter plots when passing x y with continuous variables
...
### ggplot Syntax
Notes: specify more complex syntax
...
### Alpha and Jitter
Notes: Larger the alpha, more solid the dots on the graph.
