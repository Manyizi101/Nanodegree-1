...
import re
import os
os.chdir('/Users/Cinkie/Documents/Nanodegree/MongoDB/Lesson_4_Problem_Set/01-Preparing_Data')
...
def process_file(filename, fields):
    ...
    with open(filename, "r") as f:
        ...
        for line in reader:
            ...
            if line['name'] == None or re.match('^[\w-]+$',line['name']) != None:
            ...
            for key in fields.values():
                if key in ("kingdom","family","order","phylum","genus","class"):
                    newline["classification"][key] = line[key]
                else:
